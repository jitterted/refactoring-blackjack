...
To use this project, you need the following already set up and running on your machine:

* Java 21 or later
* The IntelliJ IDEA development environment (Ultimate or Community), 2023.2 or later.
...
Once all players have either busted or stood, it's the dealer's turn to play. They turn their face-down card over. They then hit until their score is 17 or higher at which point they must stand. The dealer cannot decide to hit or stand, if their hand's score is 16 or lower, they must hit, and at 17 or higher, they must stand.
